...
export const html = `
  ...
  <p><strong>UNO !</strong> Dès que tu poses ta carte avant-dernière (il ne t'en reste plus qu'une), signale-le avec le bouton "UNO !". Tant que tu ne l'as pas fait, n'importe quel autre joueur peut te "contre-signaler" pour t'infliger 2 cartes de pénalité — mais seulement avant que quelqu'un d'autre n'ait joué ou pioché entre-temps : passé ce moment, tu es tiré d'affaire pour ce tour-ci. Les boutons "UNO !" et "Contre-UNO" restent affichés en permanence, à toi de juger du bon moment : te signaler à tort (alors que ce n'est pas ton tour de le faire) te coûte 2 cartes de pénalité ; contre-signaler quelqu'un à tort ne coûte en revanche rien, ta tentative est juste refusée.</p>
  <p><strong>Interruption</strong> : même quand ce n'est pas ton tour, si tu as une carte strictement identique (même couleur ET même symbole/valeur) à celle tout juste posée en haut de la défausse, tu peux la jouer avant que le joueur dont c'est le tour n'ait lui-même joué — elle est signalée par un liseré doré dans ta main. La partie continue alors normalement à partir de toi, comme si c'était ton tour ; le joueur initialement attendu est purement et simplement sauté. Les Jokers/Joker +4 ne permettent jamais d'interrompre (tous identiques entre eux, ça n'aurait pas de sens).</p>
`;
